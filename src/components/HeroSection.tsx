            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              ...
              <span className="text-center">
                <span className="block relative group">
                  ...
                  <span 
                    className="inline-block text-4.5xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-wider bg-gradient-to-r from-red-600 via-pink-600 to-violet-600 dark:from-red-400 dark:via-pink-400 dark:to-violet-400 text-transparent bg-clip-text relative mt-10 md:mt-8 px-2"
                    style={{
