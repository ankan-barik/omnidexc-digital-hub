...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/20 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-6 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            <h3 className="text-3xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 dark:from-gray-200 dark:to-gray-400 bg-clip-text text-transparent">
              Our Story
            </h3>
            ...
            <div className="space-y-4 pt-4">
              <div className="flex items-center space-x-3 p-3 rounded-lg bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border border-blue-100 dark:border-blue-800">
                ...
                <span className="text-gray-700 dark:text-gray-300 font-medium">End-to-end digital solutions under one roof</span>
              </div>
              <div className="flex items-center space-x-3 p-3 rounded-lg bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border border-purple-100 dark:border-purple-800">
                ...
                <span className="text-gray-700 dark:text-gray-300 font-medium">Proven track record with 10+ successful projects</span>
              </div>
              <div className="flex items-center space-x-3 p-3 rounded-lg bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border border-cyan-100 dark:border-cyan-800">
                ...
                <span className="text-gray-700 dark:text-gray-300 font-medium">Dedicated support throughout your digital journey</span>
              </div>
            </div>
            
            {/* Stats */}
            <div className="grid grid-cols-3 gap-6 pt-6">
              <div className="text-center p-6 rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-blue-100 dark:border-blue-800 shadow-lg hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="text-center p-6 rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-purple-100 dark:border-purple-800 shadow-lg hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="text-center p-6 rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-cyan-100 dark:border-cyan-800 shadow-lg hover:shadow-xl transition-all duration-300 group">
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20 dark:border-gray-700/20 hover:shadow-3xl transition-all duration-300">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((value, index) => (
            <div key={index} className={`bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 text-center group hover:shadow-2xl transition-all duration-300 border ${value.borderColor} dark:border-opacity-50 shadow-lg`}>
