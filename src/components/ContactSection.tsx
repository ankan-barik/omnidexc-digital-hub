          ...
          <div className="space-y-8">
            ...
            <div className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 rounded-3xl p-8 overflow-hidden border border-blue-100 dark:border-gray-600">
              ...
              <div className="absolute inset-0 opacity-5">
                ...
                <div className="absolute bottom-4 right-4 w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full animate-pulse" style={{animationDuration: '5s'}}></div>
                <div className="absolute top-1/2 left-1/3 w-8 h-8 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-full animate-pulse" style={{animationDuration: '3s'}}></div>
              </div>
              <ContactIllustration />
            </div>
